...
`node server.js` is used to host 3 lots of static content on different ports. One for the host application (3001), another for the remote application (3002) and the last for the components (3003.)
